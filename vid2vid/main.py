...
def main(
    ...
    model_id: str = "F:/test/ComfyUI/models/diffusers/stable-diffusion-v1-5",
    scale: float = 1.0,
    ...
    if any(word in prompt for word in ['pixelart', 'pixel art', 'Pixel art', 'PixArFK']):
        ...
        stream.stream.load_lora("F:/test/streamv2v/vid2vid/Claymation.safetensors", adapter_name='claymation')
